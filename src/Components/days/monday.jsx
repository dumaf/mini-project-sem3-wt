//First time nirav did something
...
const MondayPage = () => {
  ...
  const storageKey = "monday.json"; // Storage key for Monday's tasks

  useEffect(() => {
    // Retrieve Monday's tasks from localStorage
  ...
  useEffect(() => {
    // Store Monday's tasks in localStorage whenever tasks are updated
  ...
  return (
    <div className="bg-white p-4 rounded-lg shadow-md mb-4">
      <h2 className="text-2xl font-bold mb-3">Monday Tasks</h2>
      <div className="flex items-center mb-2">
        <input
          type="text"
          className="flex-grow p-2 border border-gray-300 rounded-l-lg focus:outline-none focus:ring-2 focus:ring-blue-500"
          placeholder="Add a task for Monday"
          value={newTask}
